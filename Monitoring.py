...
class Monitoring:
    ...
    def measure_t1(
        self, start_time=None, expt=None, param_exp=None, qubit_test=None, EF=False, debug=False, save=True
    ):
        ...
        if debug:
            ...
            if qubit_zz is not None:
                ...
                ax.text(
                    0.6,
                    0.8,
                    "Freq: %.3f +/- %.3f" % (qZZspec_fit[2], qZZspec_fit_err[2][2]),
                    transform=ax.transAxes,
                    fontsize=12,
                )
            ax.legend()
