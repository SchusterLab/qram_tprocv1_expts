...
class RamseyExperiment(Experiment):
    ...
    def analyze(self, data=None, fit=True, **kwargs):
        ...
        if fit:
            ...
            data['f_ge_adjust_ramsey_avgi'] = (self.cfg.expt.ramsey_freq - p_avgi[1], -self.cfg.expt.ramsey_freq - p_avgi[1])
            data['f_ge_adjust_ramsey_avgq'] = (self.cfg.expt.ramsey_freq - p_avgq[1], -self.cfg.expt.ramsey_freq - p_avgq[1])
            data['f_ge_adjust_ramsey_amps'] = (self.cfg.expt.ramsey_freq - p_amps[1], -self.cfg.expt.ramsey_freq - p_amps[1])
        return data
    ...
    def display(self, data=None, fit=True, **kwargs):
        ...
        if fit:
            ...
            print('Suggested new qubit frequencies from fit amps [MHz]:\n',
